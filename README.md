...
Se cambiaron las flechas en el diagrama de UML para reflejar correctamente la relación de herencia de Homicidio/Hurto con Criminal y Laborales/Lesiones con Civil, al igual que la relación de composición con las cuatro subclases y Casos.
